ExoPlayerVideoPlayback
This sample demonstrates how to play back video files that are saved in the BlackBerry Dynamics secure file system using ExoPlayer.  The same approach
could be used for audio files.
