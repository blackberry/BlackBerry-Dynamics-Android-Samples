...
import com.good.gd.example.cutcopypaste.databinding.ActivityTextWidgetsAppcompatWithInflaterBinding;
 ...
 */
public class TextWidgetsActivityAppCompatWithInflater extends TextWidgetsParentActivity {

    protected String TAG = TextWidgetsActivityAppCompatWithInflater.class.getSimpleName();

    private ActivityTextWidgetsAppcompatWithInflaterBinding binding;

    @Override
    public void onCreate(final Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);

        binding = ActivityTextWidgetsAppcompatWithInflaterBinding.inflate(getLayoutInflater());
        ...
        setupAppBarAndEnabledBackButton(getString(R.string.activity_title_widgets_appcompat_inflater));
