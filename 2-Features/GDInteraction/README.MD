...
This sample application highlights a number of interactions with the BlackBerry Dynamics runtime library, including the following.

-   Retrieval of remote settings from the enterprise management console.
-   Handling the state change and configuration events that are dispatched by
    the runtime to the application code.
