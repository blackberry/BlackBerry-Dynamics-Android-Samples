...
This client application demonstrates how to use the AppKinetics programming interface as a consumer. It is intended for use with the Greetings Server sample.
