...
Demonstrates how to create your own AppKinetics application-based service. This sample uses a fictitious Greetings Service to show how to securely share a greeting between two Dynamics applications (client and server).

This client application demonstrates how to use the AppKinetics programming interface as a consumer. It is intended for use with the Greetings Client sample.
...
4. Edit the *GDApplicationID* to your own or use the default '*com.blackberry.dynamics.sample.provider*' in the *settings.json* file in the assets directory .
