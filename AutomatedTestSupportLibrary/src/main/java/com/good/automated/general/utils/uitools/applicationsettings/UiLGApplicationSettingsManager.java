 ...
 */
class UiLGApplicationSettingsManager extends UiApplicationSettingsManager {

    UiLGApplicationSettingsManager(){
    ...
    protected UiSelector locateSelectorForForceStopButton() {
        return new UiSelector().resourceId(computeResourceId("com.android.settings","left_button"));
    }
}
