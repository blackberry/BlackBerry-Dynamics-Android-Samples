...
public class MainActivity extends AppCompatActivity implements GDStateListener
{
    ...
    ArrayList<BemsServer> bemsServers = new ArrayList<>();
    ...
    //Looks for a service provider that supports the contacts service.
    ...
    public void onOpenContacts(View view)
    {
        ...
        {
            Intent contactsIntent = new Intent(this, ContactService.class);
            contactsIntent.putExtra("com.msohm.blackberry.samples.bemscontactservicesample.BEMSServers", bemsServers);
