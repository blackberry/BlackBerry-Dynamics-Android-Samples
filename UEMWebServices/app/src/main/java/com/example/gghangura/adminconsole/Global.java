...
public class Global {
    ...
    public String[] getFromPreferneces() {
        ...
        values[0] = sp.getString("url","");
        values[1] = sp.getString("provider","");
        values[2] = sp.getString("auth","");
        values[3] = sp.getString("tenant","");
        values[4] = sp.getString("username","");
        values[5] = sp.getString("password","");
