# Secure File System and Wearable Companion

## Description

This sample code demonstrates how to use the following features.

-   BlackBerry Dynamics secure file system.
-   BlackBerry Dynamics Wearable Framework.

The sample contains two applications:

-   handheld_app, for smartphones and tablet devices running Android.
-   wearable_app, for watches and other wearable devices running Android Wear.

Data and commands can be exchanged securely between the two applications.
