...
/* Blackberry modifications - Import GD APIs  */
...
/* Blackberry modifications - Activity implements GDStateListener for GD lifecyle callbacks  */
public class NativeMedia extends Activity implements GDStateListener {
/* Blackberry modifications - end  */
    ...
    public void onCreate(Bundle icicle) {
        ...
        /* Blackberry modifications - register Activity with GD SDK - Will start GD activation & auth process */
        ...
        sourceSpinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int pos, long id) {
                ...
                /* Blackberry modifications - - Copy file to secure container when selected */
                if(mSourceString!=null) {
                    copyToSecureContainer(mSourceString);
                }
                /* Blackberry modifications - end  */
            }
    ...
    /* Blackberry modifications - GD Lifecycle methods  */
    @Override
    public void onAuthorized() {

        mGDAuthorized = true;
        
        //Now authprized, copy selected file to secure container (if required)
        if(mSourceString!=null) {
            copyToSecureContainer(mSourceString);
        }
    ...
    /* Blackberry modifications - Utility methods to copy media file from SD card into GD Secure Container
     
     This is a sample/example, in reality video file wouldn't be in the SD card folder but received over
     Secure Network connection
     
     */
    private boolean copyToSecureContainer(String path) {

        Log.i("NativeMedia", "InputFileName = " + path);
        ...
        try {
                ...
                com.good.gd.file.File destFile = new com.good.gd.file.File(srcFile.getParent(), srcFile.getName());

                Log.i("NativeMedia", "OutputFileName = " + destFile.getPath());
    ...
    private void copyFile(File sourceLocation , com.good.gd.file.File targetLocation)
            throws IOException {
    ...
    private boolean mGDAuthorized = false;
