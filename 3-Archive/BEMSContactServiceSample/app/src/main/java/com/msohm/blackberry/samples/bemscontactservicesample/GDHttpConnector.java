...
public class GDHttpConnector
{
    ...
    private static final String TAG = "com.msohm.blackberry.samples.bemscontactservicesample.GDHttpConnector";
            ...
            throws IOException
    {
        ...
        Log.d(TAG, "Get Response Code: " + response.getStatusLine().getStatusCode());
