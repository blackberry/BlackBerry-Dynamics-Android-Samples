# BlackBerry Dynamics Getting Started Java Sample App for Android

This sample pairs with 'GettingStarted' to provide an example of an Android application before and after integrating with the BlackBerry Dynamics SDK.
