# BlackBerry Dynamics Getting Started Kotlin Sample App for Android

This sample pairs with 'GettingStarted-Kotlin' to provide an example of an Android application before and after integrating with the BlackBerry Dynamics SDK.
